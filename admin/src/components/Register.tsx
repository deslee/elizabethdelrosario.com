...
import { RegisterInputShape, RegisterPayload, RegisterInput } from 'api';
...
export default compose<Props, ComponentProps>(
    withApollo,
    graphql<WithApolloClient<ComponentProps>, RegisterResult, RegisterVariables, MutateProps<RegisterResult, RegisterVariables>>(gql`
